				...
				<el-form :model="ruleForm" :rules="rules" ref="ruleForm" id="ruleForm" label-width="0" size="large">
					...
					<el-form-item prop="password">
						<el-input
							...
							clearable show-password :placeholder="$t('login.PWPlaceholder')"
							@keyup.enter="submitForm()"
						></el-input>
					</el-form-item>
					...
					<el-form-item>
						<el-button type="primary" style="width: 100%;" :loading="islogin" round @click="submitForm">{{ $t('login.signIn') }}</el-button>
					</el-form-item>
				</el-form>
...
<style scoped>
	...
	.login_adv__bottom p {line-height: 25px;}
	...
	.login-header .logo img {width: 55px;vertical-align: bottom;margin-right: 10px;}
	.login-header .logo label {font-size: 24px;}
	.login-header h2 {font-size: 24px;font-weight: bold;margin-top: 30px;}
	...
	.login-code {
		width: 130px; height: 38px; vertical-align: bottom;
	}

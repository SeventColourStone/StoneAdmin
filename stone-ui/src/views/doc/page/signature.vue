<template>
  <el-card shadow="never" class="card">
    <h2 style="line-height: 45px;">简易模式</h2>
        <el-card>
          <h2>身份信息</h2>
          <p><el-tag>StoneAdmin API</el-tag> 的简易模式在请求时需要携带 <span class="tag">app_id</span>和<span class="tag">identity</span> 认证参数</p>
          <h2>生成identity</h2>
  ...
  <el-card shadow="never" class="card" style="margin-top:15px">
    ...
    <el-timeline>
      <el-timeline-item timestamp="签名简介" placement="top">
        <el-card>
          <h2>签名简介</h2>
          <p><el-tag>StoneAdmin API</el-tag> 的签名主要是用于获取身份令牌 <span class="tag">AccessToken</span> 时所需必要认证参数</p>

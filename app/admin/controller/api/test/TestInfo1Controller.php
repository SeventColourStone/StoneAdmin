...
namespace app\admin\controller\api\test;


use app\admin\service\test\TestInfo1Service;
use app\admin\validate\test\TestInfo1Validate;
 ...
 * @package app\admin\controller\api\test
 */

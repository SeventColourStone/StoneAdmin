...
use app\admin\service\core\SystemDictFieldService;
use app\admin\validate\core\SystemDictFieldValidate;
...
class SystemDictFieldController extends NyuwaController
{
    ...
    /**
     * @Inject
     * @var SystemDictFieldValidate 验证器
     */
    protected $validate;

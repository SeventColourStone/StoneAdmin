...
namespace app\admin\controller\api\generate;


use app\admin\service\generate\GenerateColumnsService;
use app\admin\validate\generate\GenerateColumnsValidate;
 ...
 * @package app\admin\controller\api\generate
 */
class GenerateColumnsController extends NyuwaController
{
    /**
     * GenerateColumnsService 服务
     * @Inject
    ...
    /**
     * @Inject
     * @var GenerateColumnsValidate 验证器
     */
    protected $validate;

...
class SystemMenu extends NyuwaModel
{
     ...
     * @var array
     */
    protected $fillable = ['parent_id','level','name','code','icon','route','component','redirect','is_hidden','type','open_type','status','sort','created_by','updated_by','created_at','updated_at','deleted_at','remark',];

...
class SystemUserValidate extends NyuwaValidate
{
    ...
    protected $scene = [
        "key" => ["id"],
        "create" => ["username","nickname","phone","password","dept_id","role_ids","email","status","remark"],
        "homoPage" => ["id","dashboard"],
        "login" => ["username","password","code"],
        "password" => ["newPassword","newPassword_confirmation","oldPassword"],
        "status" => ["id","status"],
        "update" => ["id","avatar","username","nickname","phone","password","dept_id","role_ids","post_ids","email","status","remark"],
        "modifyPassword" => ["newPassword","newPassword_confirmation","oldPassword"]
    ];
}

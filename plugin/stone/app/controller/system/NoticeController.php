...
use plugin\stone\app\service\system\SystemNoticeService;
use plugin\stone\app\validate\system\SystemNoticeValidate;
...
class NoticeController extends NyuwaController
{
    ...
    #[Inject]
    protected SystemNoticeValidate $validate;

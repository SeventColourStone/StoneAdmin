...
use plugin\stone\app\mapper\setting\SettingGenerateTablesMapper;
...
use plugin\stone\nyuwa\generator\ModelGenerator;
use plugin\stone\nyuwa\generator\RequestGenerator;
...
class SettingGenerateTablesService extends AbstractService
{
    ...
    public function __construct(SettingGenerateTablesMapper $mapper,DataSourceService $dataMaintainService,SettingGenerateColumnsService $settingGenerateColumnsService,ModuleService $moduleService)
    {
        $this->mapper = $mapper;
    ...
    public function updateTableAndColumns(array $data): bool
    {
        ...
        $data['namespace'] = "plugin\\{$data['module_name']}\\app";
...
//        try {
            ...
            var_dump("generateCodeFile:".$adminId);

...
use plugin\stone\app\mapper\system\SystemUserMapper;
...
class SystemUserService extends AbstractService
{
    ...
    public function login(UserServiceVo $userServiceVo)
    {
        try {
            ...
            var_dump("webLoginVerify",$webLoginVerify);
            ...
            Log::error(nyuwa_trans('jwt.unknown_error').":".$e->getFile()."||".$e->getLine()."||".$e->getMessage()."||");

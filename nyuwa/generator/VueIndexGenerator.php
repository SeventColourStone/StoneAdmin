...
use nyuwa\generator\traits\VueFunctionsVarsTraits;
 ...
 */
class VueIndexGenerator extends NyuwaGenerator implements CodeGenerator
{
    ...
    public function generator($genFilePath = null): void
    {
        ...
        if (!empty($genFilePath)){
            $path = $genFilePath."/vue/src/views/{$module}/{$this->getShortBusinessName()}/index.vue";
            $this->filesystem->mkdir(
        ...
        var_dump("文件生成VueIndexGenerator");
    }
